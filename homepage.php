...
<body>
    ...
    <div class="container">
      <div class="row min-vh-100 align-items-center">
        <div class="content text-center text-md-left">
          ...
          <p>Join our vibrant community and unlock exclusive benefits! Sign up today to access premium content, connect
            with like-minded individuals, and stay updated with the latest news and events.Effortlessly organize, track,
            and refill prescriptions for optimal health and convenience.</p>
    ...
    <div class="container">
      <div class="row align-items-center">
        <div class="col-md-6 image">
          <img src="images/newdoctor.jpg" class="w-100 mb-5 mb-mb-0">
        </div>
  ...
  <section class="services" id="services">
    ...
    <div class="box-container container">
      <div class="box">
        <img src="images/workprocess7.jpg">
      ...
      <div class="box">
        <img src="images/workprocess4.jpg">
      ...
      <div class="box">
        <img src="images/workprocess5.jpg">
      ...
      <div class="box">
        <img src="images/workprocess6.jpg">
  ...
  <section class="process">
    ...
    <div class="box-container container">
      <div class="box">
        <img src="images/workprocess8.jpg" alt="">
  ...
  <section class="reviews" id="reviews">
    ...
    <div class="box-container container">
      <div class="box">
        <img src="images/reviewsno1.jpg" alt="">
      ...
      <div class="box">
        <img src="images/reviwesno2.jpg" alt="">
      ...
      <div class="box">
        <img src="images/reviewsno3.jpg" alt="">
